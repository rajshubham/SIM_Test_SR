...
namespace PRGX.SIMTrax.ViewModel
{
    public class ChangePassword
    {
        ...
        [Required(ErrorMessage = null, ErrorMessageResourceName = Constants.OLD_PASSWORD_ERROR, ErrorMessageResourceType = typeof(prgxResource))]
        [DataType(DataType.Password)]
        [StringLength(15, MinimumLength = 6, ErrorMessage = null, ErrorMessageResourceName = Constants.PASSWORD_LENGTH, ErrorMessageResourceType = typeof(prgxResource))]
        [RegularExpression("((?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#*$%_!&]).{6,15})", ErrorMessage = null, ErrorMessageResourceName = Constants.PASSWORD_MESSAGE, ErrorMessageResourceType = typeof(prgxResource))]
        [Display(Name = Constants.OLD_PASSWORD_MESSAGE, ResourceType = typeof(prgxResource))]
        public string OldPassword { get; set; }

        [Required(ErrorMessage = null, ErrorMessageResourceName = Constants.NEW_PASSWORD_ERROR, ErrorMessageResourceType = typeof(prgxResource))]
        [DataType(DataType.Password)]
        [StringLength(15, MinimumLength = 6, ErrorMessage = null, ErrorMessageResourceName = Constants.PASSWORD_LENGTH, ErrorMessageResourceType = typeof(prgxResource))]
        [RegularExpression("((?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#*$%_!&]).{6,15})", ErrorMessage = null, ErrorMessageResourceName = Constants.PASSWORD_MESSAGE, ErrorMessageResourceType = typeof(prgxResource))]
        [Display(Name = Constants.NEW_PASSWORD_MESSAGE, ResourceType = typeof(prgxResource))]
        ...
        [RegularExpression("((?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#*$%_!&]).{6,15})", ErrorMessage = null, ErrorMessageResourceName = Constants.PASSWORD_MESSAGE, ErrorMessageResourceType = typeof(prgxResource))]
        [Compare("NewPassword", ErrorMessage = null, ErrorMessageResourceName = Constants.COMPARE_PASSWORD_AND_CONFIRM_PASSWORD_FAIL, ErrorMessageResourceType = typeof(prgxResource))]
