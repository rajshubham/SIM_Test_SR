...
using PRGX.SIMTrax.DAL.Repository;
...
{
    public class EmailUow : GenericUow, IEmailUow , IDisposable
    {
        public EmailUow(IRepositoryProvider repositoryProvider)
        {
            CreateDbContext();
        ...
        public  IEmailTemplateRepository EmailTemplates { get { return GetRepo<IEmailTemplateRepository>(); } }

        public IGenericRepository<EmailAudit> EmailAudits { get { return GetStandardRepo<EmailAudit>(); } }
        ...
        private EmailContext DbContext { get; set; }
