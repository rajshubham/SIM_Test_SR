...
{
    /// <summary>
    /// Provides an <see cref="IGenericRepository{T}"/> for a client request.
    /// </summary>
    /// <remarks>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// Get or create-and-cache the default <see cref="IGenericRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        /// Root entity type of the <see cref="IGenericRepository{T}"/>.
        /// </typeparam>
        /// <remarks>
